...
DEBUG = True
OUT_PREFIX = "lider_mundo_bebe_jugueteria"

HOME_URL = BASE
CATEGORY_NAME = "Mundo Bebé y Juguetería"
CATEGORY_LANDING = f"{BASE}/browse/mundo-bebe-y-jugueteria"
...
async def discover_subcategories(browser: Browser) -> List[dict]:
    ...
    try:
        ...
        # 2) Activar Mundo Bebé y Juguetería en la columna izquierda
        category_activated = False
        category_selectors = [
            'text="Mundo Bebé y Juguetería"',
            'a:has-text("Mundo Bebé y Juguetería")',
            'button:has-text("Mundo Bebé y Juguetería")',
            '[role="menuitem"]:has-text("Mundo Bebé y Juguetería")',
        ]
        ...
        for sel in category_selectors:
            try:
                ...
                if (
                    "pañales y toallas húmedas" in body_text
                    and "alimentación y lactancia" in body_text
                    and "juguetería" in body_text
                ):
        ...
        if not category_activated:
            raise RuntimeError("No se pudo desplegar el mega menú de Mundo Bebé y Juguetería")

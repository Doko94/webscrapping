...
SECTION_LEFT_TEXT = "Limpieza"
SECTION_SLUG = "limpieza"
...
def plan_b_urls():
    ...
    grupos = [
        ...
        {
            "group": "Baño y cocina",
            "group_slug": "bano-y-cocina",
            "subcats": [
                "Lavalozas y lavavajillas",
                "Limpiador crema",
                "Limpiador antigrasa",
                "Limpiador baño",
                "Cloro",
                "Paños, esponjas y guantes",
                "Sopapos",
            ],
        },
        {
            "group": "Limpieza hogar",
            "group_slug": "limpieza-hogar",
            "subcats": [
                "Aerosoles y desinfectantes",
                "Limpiador vidrios y multiuso",
                "Insecticidas",
                "Velas y fósforos",
            ],
        },
        {
            "group": "Pisos y muebles",
            "group_slug": "pisos-y-muebles",
            "subcats": [
                "Limpiador pisos",
                "Limpiador alfombra",
                "Lustramuebles",
                "Ceras",
                "Paños, traperos, mopas y baldes",
                "Escobas, palas, virutillas y plumeros",
            ],
        },
        {
            "group": "Accesorios aseo",
            "group_slug": "accesorios-aseo",
            "subcats": [
                "Bolsa basura",
                "Limpieza calzado y ropa",
                "Otros accesorios aseo",
            ],
        },
    ]

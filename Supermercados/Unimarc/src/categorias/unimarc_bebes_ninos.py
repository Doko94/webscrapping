...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/bebes_ninos"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Bebés y Niños"
SECTION_SLUG = "bebes-y-ninos"
...
# ---------------------------
# 1) Menú: abrir Categorías y seleccionar Bebés y Niños
# ---------------------------
...
async def get_subcats_from_menu(page):
    ...
    groups = ["Alimentación", "Pañales y toallas húmedas", "Perfumería"]
    out = []
    for g in groups:
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Alimentación",
            "group_slug": "alimentacion",
            "subcats": [
                "Colados y picados",
                "Cereales y postres",
                "Leches y fórmulas",
                "Mamaderas, chupetes y accesorios",
            ],
        },
        {
            "group": "Pañales y toallas húmedas",
            "group_slug": "panales-y-toallas-humedas",
            "subcats": [
                "Pañales",
                "Toallas húmedas",
            ],
        ...
        {
            "group": "Perfumería",
            "group_slug": "perfumeria",
            "subcats": [
                "Shampoo y acondicionadores",
                "Jabones",
                "Perfumes y colonias",
                "Talco, pomadas y varitas de algodón",
                "Cremas y aceites",
                "Ropa y accesorios",
            ],
        },

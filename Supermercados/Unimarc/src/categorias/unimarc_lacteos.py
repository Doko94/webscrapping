...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/lacteos"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Lácteos, Huevos y Refrigerados"
SECTION_SLUG = "lacteos-huevos-y-refrigerados"
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Leches y cremas",
            "group_slug": "leches-y-cremas",
            "subcats": [
                "Leches blancas",
                "Leches sin lactosa",
                "Leches saborizadas",
                "Leches cultivadas",
                "Cremas",
                "Leche en polvo y suplementos",
                "Saborizantes para leche",
                "Bebidas lácteas",
                "Leches individuales",
            ],
        },
        {
            ...
            "subcats": [
                ...
                "Proteína",
                "Trozos y especiales",
                "Con cereal e infantiles",
                "Probióticos y funcionales",
                "Formato familiar",
            ],
        },
        {
            "group": "Mantequillas",
            "group_slug": "mantequillas",
            "subcats": [
                "Mantequilla",
                "Margarina y manteca",
            ],
        ...
        },
        {
            ...
            "subcats": [
                ...
                "Jaleas",
                "Flanes",
                "Leche asada y arroz con leche",
                "Sémolas",
                "Postres especiales",
            ],
        },
        {
            "group": "Bebidas vegetales",
            "group_slug": "bebidas-vegetales",
            "subcats": [
                "Ver todo",
            ],
        },

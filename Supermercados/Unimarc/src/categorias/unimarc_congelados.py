...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/congelados"))

# OUTPUT_DIR = Path(
#     r"C:\Users\fvergram\OneDrive - NTT DATA EMEAL\Desktop\webscrapping\Supermercados\Unimarc\src\output\congelados"
# )
...
SECTION_LEFT_TEXT = "Congelados"
SECTION_SLUG = "congelados"

GROUPS = [
    "Hielo, helados y postres",
    "Frutas y verduras congeladas",
    "Hamburguesas, apanados y churrascos",
    "Pescados y mariscos",
    "Platos congelados",
]
...
# ---------------------------
# FIX CRÍTICO: extraer links por bloque SIN inner_text()
# ---------------------------
async def get_links_under_group(page, section_slug: str, group_title: str):
    ...
    rows = await group_block.locator("a[href*='/category/']").evaluate_all(
        """(els) => els.map(a => ({
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Hielo, helados y postres",
            "group_slug": "hielo-helados-y-postres",
            "subcats": [
                "Helados cremosos",
                "Pack helados individuales",
                "Helados premium",
                "Helados agua y fruta",
                "Helados light",
                "Postres helados",
                "Hielo",
            ],
        ...
        {
            "group": "Frutas y verduras congeladas",
            "group_slug": "frutas-y-verduras-congeladas",
            "subcats": [
                "Verduras congeladas",
                "Mix de verduras",
                "Frutas",
        ...
        {
            "group": "Hamburguesas, apanados y churrascos",
            "group_slug": "hamburguesas-apanados-y-churrascos",
            "subcats": [
        ...
        },
        {
            ...
            "group_slug": "pescados-y-mariscos",
            "subcats": [
                "Pescados",
                "Mariscos",
                "Camarones",
        ...
        {
            "group": "Platos congelados",
            "group_slug": "platos-congelados",
            "subcats": [
                "Pizza",
                "Platos preparados",
                "Postres congelados",

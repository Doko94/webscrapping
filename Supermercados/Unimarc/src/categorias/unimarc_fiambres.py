...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/fiambres"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Quesos y Fiambres"
SECTION_SLUG = "quesos-y-fiambres"

# Grupos como aparecen en el panel
GROUPS = [
...
# ---------------------------
# 1) Menú: abrir Categorías y seleccionar Quesos y Fiambres
# ---------------------------
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Fiambres y embutidos",
            "group_slug": "fiambres-y-embutidos",
            "subcats": [
                "Jamón y mortadela",
                "Salame y tocino",
                "Jamón serrano y otros",
                "Paté",
                "Salchichas",
                "Parrilleros",
            ],
        },
        {
            ...
            "subcats": [
                ...
                "Queso fresco",
                "Especiales y tablas",
                "Queso crema y untables",
                "Cabra y oveja",
                "Rallados y granulados",
            ],
        },
    ]

...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/carnes"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Carnes"
SECTION_SLUG = "carnes"
...
def plan_b_urls():
    ...
    grupos = [
        ...
        },
        {
            ...
            "subcats": [
                "Pechuga y filete",
                "Pavo molido y picado",
                "Pavo entero",
                "Trutros y otros",
            ],
        },
        {
            "group": "Cordero y otros",
            "group_slug": "cordero-y-otros",
            "subcats": [
                "Cordero",
                "Otros",
            ],
    ...
    out = []
    for grupo in grupos:
        if not grupo["subcats"]:
            out.append({
                "group": grupo["group"],
                "name": grupo["group"],
                "url": f"{base}/{grupo['group_slug']}",
            })
            continue

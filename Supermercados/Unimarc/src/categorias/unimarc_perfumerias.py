...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/perfumerias"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Perfumería"
SECTION_SLUG = "perfumeria"

# Grupos tal como aparecen en el panel
GROUPS = [
    "Cuidado capilar",
    "Cuidado bucal",
    "Cuidado personal",
...
# ---------------------------
# Menú: abrir Categorías y seleccionar sección
# ---------------------------
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Cuidado capilar",
            "group_slug": "cuidado-capilar",
            "subcats": [
                "Shampoo",
                "Acondicionador",
                "Cremas para peinar",
                "Coloración y tinturas",
                "Fijadores",
                "Cepillos, peinetas y accesorios",
            ],
        },
        {
            "group": "Cuidado bucal",
            "group_slug": "cuidado-bucal",
            "subcats": [
                "Pasta dental",
                "Cepillos",
                "Enjuague bucal y sedas",
            ],
        },
        {
            "group": "Cuidado personal",
            "group_slug": "cuidado-personal",
            "subcats": [
                "Jabón en barra",
                "Jabón líquido",
                "Gel de ducha",
                "Alcohol gel",
                "Cosméticos y desmaquillantes",
                "Cuidado pies",
                "Esponjas y accesorios",
            ],
        },
        {
            "group": "Cuidado corporal y facial",
            "group_slug": "cuidado-corporal-y-facial",
            "subcats": [
                "Cremas corporales",
                "Cremas de mano",
                "Protección solar",
        ...
        {
            "group": "Cuidado femenino",
            "group_slug": "cuidado-femenino",
            "subcats": [
                "Protección femenina",
                "Desodorante",
                "Depilación",
        ...
        {
            "group": "Cuidado masculino",
            "group_slug": "cuidado-masculino",
            "subcats": [
                "Desodorantes",
                "Afeitadoras y repuestos",
                "Crema, gel y espuma de afeitar",
                "Colonias",
            ],
        },
        {
            "group": "Cuidado adulto",
            "group_slug": "cuidado-adulto",
            "subcats": [
                "Pañales y pants",
                "Protectores y toallas húmedas",
                "Protección cama",
            ],
        },
        {

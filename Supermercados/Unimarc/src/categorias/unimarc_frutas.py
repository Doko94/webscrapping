...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/frutas_verdures"))

BASE = "https://www.unimarc.cl"
CATEGORIES_HUB = "https://www.unimarc.cl"
MAX_PAGES = 80

SECTION_LEFT_TEXT = "Frutas y Verduras"
SECTION_SLUG = "frutas-y-verduras"
...
# ---------------------------
# 1) Menú: abrir Categorías y seleccionar Frutas y Verduras
# ---------------------------
...
async def get_subcats_from_menu(page):
    ...
    groups = ["Frutas", "Verduras", "Frutos secos"]
    out = []
    for g in groups:

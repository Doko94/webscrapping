...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/bebidas_licores"))

# OUTPUT_DIR = Path(
#     r"C:\Users\fvergram\OneDrive - NTT DATA EMEAL\Desktop\webscrapping\Supermercados\Unimarc\src\output\bebidas_licores"
# )
...
SECTION_LEFT_TEXT = "Bebidas y Licores"
SECTION_SLUG = "bebidas-y-licores"
...
# ---------------------------
# Menú: abrir Categorías y seleccionar Bebidas y Licores
# ---------------------------
...
def plan_b_urls():
    ...
    grupos = [
        ...
        {
            "group": "Vinos y espumantes",
            "group_slug": "vinos-y-espumantes",
            "subcats": [
                "Vino tinto",
                "Vino blanco",
                "Vino caja",
                "Espumantes",
                "Vinos botellón y otros",
                "Vino Late harvest",
                "Vino rosé",
            ],
        },
        {
            "group": "Destilados y licores",
            "group_slug": "destilados-y-licores",
            "subcats": [
                "Cóctel",
                "Piscos",
                "Ron",

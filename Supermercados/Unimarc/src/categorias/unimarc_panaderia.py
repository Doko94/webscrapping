...
SECTION_LEFT_TEXT = "Panadería y Pastelería"
SECTION_SLUG = "panaderia-y-pasteleria"
...
# ---------------------------
# Menú: abrir Categorías y seleccionar Panadería y Pastelería
# ---------------------------
...
def plan_b_urls():
    ...
    grupos = [
        ...
        {
            "group": "Pan envasado",
            "group_slug": "pan-envasado",
            "subcats": [
                "Marraqueta y hallulla",
                "Pan molde y pita",
                "Pan hot dog y hamburguesa",
                "Pan especial",
                "Pan cóctel",
                "Pan para hornear",
        ...
        {
            "group": "Pastelería",
            "group_slug": "pasteleria",
            "subcats": [
                "Envasados y colaciones",
                "Tortas",
                "Masas dulces",
                "Pie, kuchen y tartas",
                "Pasteles",

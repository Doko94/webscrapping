...
SECTION_LEFT_TEXT = "Mascotas"
SECTION_SLUG = "mascotas"
...
# ---------------------------
# 1) Menú: abrir Categorías y seleccionar Mascotas
# ---------------------------
...
async def get_links_under_group(page, section_slug: str, group_title: str):
    """
    Importante: sacar links en batch (evita nth(i) y timeouts por DOM dinámico)
    """
...
async def get_subcats_from_menu(page):
    ...
    groups = ["Alimento perro", "Alimento gato", "Alimento otras mascotas", "Accesorios mascota"]
    out = []
    for g in groups:
...
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Alimento perro",
            "group_slug": "alimento-perro",
            "subcats": [
                "Alimento perro adulto",
                "Alimento cachorro",
                "Alimentos húmedos y latas",
                "Snack perros",
            ],
        },
        {
            "group": "Alimento gato",
            "group_slug": "alimento-gato",
            "subcats": [
        ...
        {
            "group": "Alimento otras mascotas",
            "group_slug": "alimento-otras-mascotas",
            "subcats": [
                "Alimentos",
            ],
        },
        {
            "group": "Accesorios mascota",
            "group_slug": "accesorios-mascota",
            "subcats": [
                "Arena y sabanillas",
                "Accesorios animales",
                "Shampoo animales",

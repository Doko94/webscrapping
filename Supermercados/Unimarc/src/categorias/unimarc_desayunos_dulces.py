...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/desayunos_dulces"))

# OUTPUT_DIR = Path(
#     r"C:\Users\fvergram\OneDrive - NTT DATA EMEAL\Desktop\webscrapping\Supermercados\Unimarc\src\output\desayunos_dulces"
# )
...
SECTION_LEFT_TEXT = "Desayuno y Dulces"
SECTION_SLUG = "desayuno-y-dulces"

# Grupos (títulos) tal como aparecen en el panel
GROUPS = [
    "Café, té y hierbas",
    "Cereales",
...
# ---------------------------
# Plan B
# Estructura: /category/desayuno-y-dulces/<grupo-slug>/<subcat-slug>
# ---------------------------
def plan_b_urls():
    ...
    grupos = [
        {
            "group": "Café, té y hierbas",
            "group_slug": "cafe-te-y-hierbas",
            "subcats": [
                "Café grano y molido",
                "Café instantáneo",
                "Cápsulas",
                "Hierbas y mate",
                "Saborizados y cremas",
                "Té ceylan",
                "Té especial",
            ],
        },
        {
            ...
            "group_slug": "cereales",
            "subcats": [
                "Chocolatados y azucarados",
                "Fibra, avena y granola",
                "Cereal inflado",
                "Barras y colaciones",
            ],
        },
        {
            "group": "Chocolates y confites",
            "group_slug": "chocolates-y-confites",
            "subcats": [
                "Chocolates",
                "Calugas, caramelos y turrones",
                "Gomitas, masticables y chupetes",
                "Marshmallows, malvas y guagüitas",
                "Chicles y mentas",
            ],
        },
        {
            "group": "Galletas y colaciones dulces",
            "group_slug": "galletas-y-colaciones-dulces",
            "subcats": [
                "Galletas bañadas y rellenas",
                "Galletas chips",
                "Galletas tradicionales, obleas y champañas",
                "Galletas saludables",
                "Galletas colación",
                "Galletones y alfajores",
            ],
        },
        {
            "group": "Mermelada y manjar",
            "group_slug": "mermelada-y-manjar",
            "subcats": [
                "Manjar",
                "Mermeladas y dulces",
            ],

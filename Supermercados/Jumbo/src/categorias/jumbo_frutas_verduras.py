...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/frutas_verduras"))
...
OUT_PREFIX = "jumbo_frutas_y_verduras"
...
SUBCATS = [
    # Frutas
    {"name": "Frutas", "url": f"{BASE}/frutas-y-verduras/frutas"},
    {"name": "Frutas Picadas", "url": f"{BASE}/frutas-y-verduras/frutas/frutas-picadas"},
    {"name": "Frutas (Mostrar todo)", "url": f"{BASE}/frutas-y-verduras/frutas"},

    # Verduras
    {"name": "Verduras", "url": f"{BASE}/frutas-y-verduras/verduras"},
    {"name": "Ensaladas", "url": f"{BASE}/frutas-y-verduras/verduras/ensaladas"},
    {"name": "Hierbas y Especias", "url": f"{BASE}/frutas-y-verduras/verduras/hierbas-y-especias"},
    {"name": "Aderezos", "url": f"{BASE}/frutas-y-verduras/verduras/aderezos"},
    {"name": "Verduras (Mostrar todo)", "url": f"{BASE}/frutas-y-verduras/verduras"},

    # Orgánicas
    {"name": "Frutas Orgánicas", "url": f"{BASE}/frutas-y-verduras/frutas-y-verduras-organicas/frutas-organicas"},
    {"name": "Verduras Orgánicas", "url": f"{BASE}/frutas-y-verduras/frutas-y-verduras-organicas/verduras-organicas"},
    {"name": "Orgánicas (Mostrar todo)", "url": f"{BASE}/frutas-y-verduras/frutas-y-verduras-organicas"},

    # Frutos secos y semillas
    {"name": "Frutos Secos", "url": f"{BASE}/frutas-y-verduras/frutos-secos-y-semillas/frutos-secos"},
    {"name": "Frutas Deshidratadas", "url": f"{BASE}/frutas-y-verduras/frutos-secos-y-semillas/frutas-deshidratadas"},
    {"name": "Semillas y Granos", "url": f"{BASE}/frutas-y-verduras/frutos-secos-y-semillas/semillas-y-granos"},
    {"name": "Frutos Secos y Semillas (Mostrar todo)", "url": f"{BASE}/frutas-y-verduras/frutos-secos-y-semillas"},
]

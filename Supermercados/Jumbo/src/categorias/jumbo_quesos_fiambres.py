...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/quesos_fiambres"))
...
OUT_PREFIX = "jumbo_quesos_y_fiambres"

# -------------------------
# Subcategorías (Plan C manual)
# -------------------------
SUBCATS = [
    # Quesos
    {"name": "Quesos", "url": f"{BASE}/quesos-y-fiambres/quesos"},
    {"name": "Especiales y Tablas de Quesos", "url": f"{BASE}/quesos-y-fiambres/quesos/especiales-y-tablas-de-quesos"},
    {"name": "Mantecosos y Chanco", "url": f"{BASE}/quesos-y-fiambres/quesos/mantecosos-y-chanco"},
    {"name": "Cabra y Oveja", "url": f"{BASE}/quesos-y-fiambres/quesos/cabra-y-oveja"},
    {"name": "Chacras, Frescos y Quesillos", "url": f"{BASE}/quesos-y-fiambres/quesos/chacras-frescos-y-quesillos"},
    {"name": "Quesos (Mostrar todo)", "url": f"{BASE}/quesos-y-fiambres/quesos"},

    # Fiambres
    {"name": "Fiambres", "url": f"{BASE}/quesos-y-fiambres/fiambres"},
    {"name": "Jamones", "url": f"{BASE}/quesos-y-fiambres/fiambres/jamones"},
    {"name": "Jamón Serrano, Lomo Kassler y Otros", "url": f"{BASE}/quesos-y-fiambres/fiambres/jamon-serrano-lomo-kassler-y-otros"},
    {"name": "Pechuga de Pavo y Pollo", "url": f"{BASE}/quesos-y-fiambres/fiambres/pechuga-de-pavo-y-pollo"},
    {"name": "Salames y Tocinos", "url": f"{BASE}/quesos-y-fiambres/fiambres/salames-y-tocinos"},
    {"name": "Fiambres (Mostrar todo)", "url": f"{BASE}/quesos-y-fiambres/fiambres"},

    # Salchichas y Parrilleros
    {"name": "Salchichas y Parrilleros", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros"},
    {"name": "Salchichas", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros/salchichas"},
    {"name": "Longanizas y Chorizos", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros/longanizas-y-chorizos"},
    {"name": "Butifarras y Longanicillas", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros/butifarras-y-longanicillas"},
    {"name": "Prietas", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros/prietas"},
    {"name": "Salchichas y Parrilleros (Mostrar todo)", "url": f"{BASE}/quesos-y-fiambres/salchichas-y-parrilleros"},

    # Aceitunas, Pepinillos y Otros
    {"name": "Aceitunas, Pepinillos y Otros", "url": f"{BASE}/quesos-y-fiambres/aceitunas-pepinillos-y-otros"},
    {"name": "Aceitunas", "url": f"{BASE}/quesos-y-fiambres/aceitunas-pepinillos-y-otros/aceitunas"},
    {"name": "Pepinillos y Pickles", "url": f"{BASE}/quesos-y-fiambres/aceitunas-pepinillos-y-otros/pepinillos-y-pickles"},
    {"name": "Chucrut y Otros", "url": f"{BASE}/quesos-y-fiambres/aceitunas-pepinillos-y-otros/chucrut-y-otros"},
    {"name": "Aceitunas, Pepinillos y Otros (Mostrar todo)", "url": f"{BASE}/quesos-y-fiambres/aceitunas-pepinillos-y-otros"},
]

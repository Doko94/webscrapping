...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/hogar_jugueteria_libreria"))
...
OUT_PREFIX = "jumbo_hogar_jugueteria_libreria"
...
SUBCATS = [
    # Juguetería
    {"name": "Autos y Autopistas", "url": f"{BASE}/hogar-jugueteria-y-libreria/jugueteria/autos-y-autopistas"},
    {"name": "Muñecas", "url": f"{BASE}/hogar-jugueteria-y-libreria/jugueteria/munecas"},
    {"name": "Peluches", "url": f"{BASE}/hogar-jugueteria-y-libreria/jugueteria/peluches"},
    {"name": "Juguetes de Roles y Mini Hogar", "url": f"{BASE}/hogar-jugueteria-y-libreria/jugueteria/juguetes-de-roles-y-mini-hogar"},
    {"name": "Juguetería (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/jugueteria"},

    # Hogar
    {"name": "Cocina y Mesa", "url": f"{BASE}/hogar-jugueteria-y-libreria/hogar/cocina-y-mesa"},
    {"name": "Celebraciones", "url": f"{BASE}/hogar-jugueteria-y-libreria/hogar/celebraciones"},
    {"name": "Decoración", "url": f"{BASE}/hogar-jugueteria-y-libreria/hogar/decoracion"},
    {"name": "Baño", "url": f"{BASE}/hogar-jugueteria-y-libreria/hogar/bano"},
    {"name": "Hogar (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/hogar"},

    # Electro y Tecnología
    {"name": "Electrodomésticos", "url": f"{BASE}/hogar-jugueteria-y-libreria/electro-y-tecnologia/electrodomesticos"},
    {"name": "Tecnología", "url": f"{BASE}/hogar-jugueteria-y-libreria/electro-y-tecnologia/tecnologia"},
    {"name": "Calefacción", "url": f"{BASE}/hogar-jugueteria-y-libreria/electro-y-tecnologia/calefaccion"},
    {"name": "Ventilación", "url": f"{BASE}/hogar-jugueteria-y-libreria/electro-y-tecnologia/ventilacion"},
    {"name": "Electro y Tecnología (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/electro-y-tecnologia"},

    # Deportes
    {"name": "Fitness", "url": f"{BASE}/hogar-jugueteria-y-libreria/deportes/fitness"},
    {"name": "Camping", "url": f"{BASE}/hogar-jugueteria-y-libreria/deportes/camping"},
    {"name": "Fútbol", "url": f"{BASE}/hogar-jugueteria-y-libreria/deportes/futbol"},
    {"name": "Ciclismo", "url": f"{BASE}/hogar-jugueteria-y-libreria/deportes/ciclismo"},
    {"name": "Deportes (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/deportes"},

    # Automóvil, Ferretería y Jardín
    {"name": "Automóvil", "url": f"{BASE}/hogar-jugueteria-y-libreria/automovil-ferreteria-y-jardin/automovil"},
    {"name": "Ferretería", "url": f"{BASE}/hogar-jugueteria-y-libreria/automovil-ferreteria-y-jardin/ferreteria"},
    {"name": "Jardín", "url": f"{BASE}/hogar-jugueteria-y-libreria/automovil-ferreteria-y-jardin/jardin"},
    {"name": "Pilas y Linternas", "url": f"{BASE}/hogar-jugueteria-y-libreria/automovil-ferreteria-y-jardin/pilas-y-linternas"},
    {"name": "Automóvil, Ferretería y Jardín (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/automovil-ferreteria-y-jardin"},

    # Librería y Escolares
    {"name": "Cuadernos", "url": f"{BASE}/hogar-jugueteria-y-libreria/libreria-y-escolares/cuadernos"},
    {"name": "Artículos de Oficina", "url": f"{BASE}/hogar-jugueteria-y-libreria/libreria-y-escolares/articulos-de-oficina"},
    {"name": "Mochilas, Loncheras y Estuches", "url": f"{BASE}/hogar-jugueteria-y-libreria/libreria-y-escolares/mochilas-loncheras-y-estuches"},
    {"name": "Libros", "url": f"{BASE}/hogar-jugueteria-y-libreria/libreria-y-escolares/libros"},
    {"name": "Librería y Escolares (Mostrar todo)", "url": f"{BASE}/hogar-jugueteria-y-libreria/libreria-y-escolares"},
]

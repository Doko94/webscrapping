...
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/panaderia_pasteleria"))
...
OUT_PREFIX = "jumbo_panaderia_y_pasteleria"

# -------------------------
# Subcategorías (Plan C manual) según menú
# -------------------------
SUBCATS = [
    # Panadería Granel
    {"name": "Pan Artesanal", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-granel/pan-artesanal"},
    {"name": "Pan Especial", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-granel/pan-especial"},
    {"name": "Pan Tradicional", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-granel/pan-tradicional"},
    {"name": "Pan Ciabatta", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-granel/pan-ciabatta"},
    {"name": "Panadería Granel (Mostrar todo)", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-granel"},

    # Panadería Envasada
    {"name": "Pan de Molde", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-envasada/pan-de-molde"},
    {"name": "Pan Congelado y Precocido", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-envasada/pan-congelado-y-precocido"},
    {"name": "Pan Integral y Funcional", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-envasada/pan-integral-y-funcional-envasado"},
    {"name": "Pan sin Gluten", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-envasada/pan-sin-gluten"},
    {"name": "Panadería Envasada (Mostrar todo)", "url": f"{BASE}/panaderia-y-pasteleria/panaderia-envasada"},

    # Pastelería
    {"name": "Tortas", "url": f"{BASE}/panaderia-y-pasteleria/pasteleria/tortas"},
    {"name": "Pan de Pascua", "url": f"{BASE}/panaderia-y-pasteleria/pasteleria/pan-de-pascua"},
    {"name": "Kuchen, Pie y Tartaletas", "url": f"{BASE}/panaderia-y-pasteleria/pasteleria/kuchen-pie-y-tartaletas"},
    {"name": "Muffins, Queques y Magdalenas", "url": f"{BASE}/panaderia-y-pasteleria/pasteleria/muffins-queques-y-magdalenas"},
    {"name": "Pastelería (Mostrar todo)", "url": f"{BASE}/panaderia-y-pasteleria/pasteleria"},

    # Masas y Tortillas
    {"name": "Masas para Pizza", "url": f"{BASE}/panaderia-y-pasteleria/masas-y-tortillas/masas-para-pizza"},
    {"name": "Tortillas", "url": f"{BASE}/panaderia-y-pasteleria/masas-y-tortillas/tortillas"},
    {"name": "Masas Empanadas y Pascualinas", "url": f"{BASE}/panaderia-y-pasteleria/masas-y-tortillas/masas-empanadas-y-pascualinas"},
    {"name": "Otras Masas", "url": f"{BASE}/panaderia-y-pasteleria/masas-y-tortillas/otras-masas"},
    {"name": "Masas y Tortillas (Mostrar todo)", "url": f"{BASE}/panaderia-y-pasteleria/masas-y-tortillas"},
]

...
# OUTPUT (ruta final)
# =========================
OUTPUT_DIR = Path(os.getenv("SCRAPER_OUTPUT_DIR", "output/mascotas"))
OUT_PREFIX = "jumbo_mascotas"
...
SUBCATS = [
    # Perros
    {"name": "Alimentos Secos Perros", "url": f"{BASE}/mascotas/perros/alimentos-secos-perros"},
    {"name": "Alimentos Húmedos Perros", "url": f"{BASE}/mascotas/perros/alimentos-humedos-perros"},
    {"name": "Snacks, Salsas y Huesos", "url": f"{BASE}/mascotas/perros/snacks-salsas-y-huesos"},
    {"name": "Cuidado e Higiene de Perros", "url": f"{BASE}/mascotas/perros/cuidado-e-higiene-de-perros"},
    {"name": "Perros (Mostrar todo)", "url": f"{BASE}/mascotas/perros"},

    # Gatos
    {"name": "Alimentos Secos Gatos", "url": f"{BASE}/mascotas/gatos/alimentos-secos-gatos"},
    {"name": "Alimentos Húmedos Gatos", "url": f"{BASE}/mascotas/gatos/alimentos-humedos-gatos"},
    {"name": "Snacks y Salsas Gatos", "url": f"{BASE}/mascotas/gatos/snacks-y-salsas-gatos"},
    {"name": "Arenas e Higiene Gatos", "url": f"{BASE}/mascotas/gatos/arenas-e-higiene-gatos"},
    {"name": "Gatos (Mostrar todo)", "url": f"{BASE}/mascotas/gatos"},

    # Otras Mascotas
    {"name": "Aves", "url": f"{BASE}/mascotas/otras-mascotas/aves"},
    {"name": "Peces", "url": f"{BASE}/mascotas/otras-mascotas/peces"},
    {"name": "Roedores", "url": f"{BASE}/mascotas/otras-mascotas/roedores"},
    {"name": "Otras Mascotas (Mostrar todo)", "url": f"{BASE}/mascotas/otras-mascotas"},
]
...
async def main():
    async with async_playwright() as p:
        ...
        out_csv_path = OUTPUT_DIR / f"{OUT_PREFIX}_{ts}.csv"
        write_csv(out_rows, str(out_csv_path))

        print("\nTotal filas:", len(out_rows))
        print("CSV generado:", out_csv_path)

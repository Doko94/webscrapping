...
SCRIPTS_TO_RUN = [
    "jumbo_carnes_pescados.py",
    "jumbo_chocolates_galleras_snack.py",
    "jumbo_cuidado_personal_bebe.py",
    "jumbo_despensa.py",
    "jumbo_frutas_verduras.py",
    "jumbo_hogar_jugueteria_libreria.py",
    "jumbo_lacteos_huevos_congelados.py",
    "jumbo_licores_bebidas_agua.py",
    "jumbo_limpieza.py",
    "jumbo_mascotas.py",
    "jumbo_panaderia_pasteleria.py",
    "jumbo_quesos_fiambres.py",
]
